		...
		[
			...
			function (_v0) {
				return A2(
					...
					A2(
						...
						_List_fromArray(
							[
								$elm_explorations$test$Test$Html$Selector$id('todo-input')
							]),
			...
			function (_v1) {
				return A2(
					...
					_List_fromArray(
						[
							$elm_explorations$test$Test$Html$Selector$id('add-button'),
							$elm_explorations$test$Test$Html$Selector$tag('button'),
							$elm_explorations$test$Test$Html$Selector$text('Add')
						]),
					A2(
						$elm_explorations$test$Test$Html$Query$index,
						1,
						A2(
			...
			function (_v2) {
				return A2(
					...
					A2(
						...
						$elm_explorations$test$Test$Html$Event$input('foo'),
						A2(
							$elm_explorations$test$Test$Html$Query$find,
							_List_fromArray(
								[
			...
			A2(
			$elm_explorations$test$Test$test,
			'typing in input then click on button creates a list item',
			function (_v4) {
				return A2(
					$elm_explorations$test$Test$Html$Query$has,
					_List_fromArray(
						[
							...
							$elm_explorations$test$Test$Html$Selector$text('foo')
						]),
					A2(
						$elm_explorations$test$Test$Html$Query$find,
						_List_fromArray(
			...
			A2(
			$elm_explorations$test$Test$test,
			'list item contains the thing you typed',
			function (_v5) {
				return A2(
					$elm_explorations$test$Test$Html$Query$has,
					_List_fromArray(
						[
							$elm_explorations$test$Test$Html$Selector$tag('li'),
							$elm_explorations$test$Test$Html$Selector$text('bar')
						]),
					A2(
						$elm_explorations$test$Test$Html$Query$find,
						_List_fromArray(
			...
			A2(
			$elm_explorations$test$Test$test,
			'initializes with no list items',
			function (_v6) {
				return A2(
			...
			A2(
			$elm_explorations$test$Test$test,
			'can add multiple todo items with the same input order',
			function (_v9) {
				return A2(
					$elm_explorations$test$Test$Html$Query$has,
					_List_fromArray(
			...
			A2(
			$elm_explorations$test$Test$test,
			'disable add button when there\'s no input',
			function (_v10) {
				return A2(
					$elm_explorations$test$Test$Html$Query$count,
					$elm_explorations$test$Expect$equal(0),
...
var $author$project$Test$Generated$Main618385146$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/pivotal/workspace/todo/tests/Example.elm']),
		processes: 8,
